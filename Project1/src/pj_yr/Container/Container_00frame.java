...
public class Container_00frame extends JFrame {
    ...
    public Container_00frame() {
        ...
        new Container_04imageSpoon(label4a, "img/daseul/text3.png");
        ...
        new Container_04imageSpoon(label4b, "img/daseul/text4.png");
        ...
        new Container_04imageSpoon(label4c, "img/daseul/text5.png");
        ...
        new Container_04imageSpoon(label6a, "img/daseul/text6.png");
        ...
        new Container_04imageSpoon(label6b, "img/daseul/text7.png");
        ...
        new Container_04imageSpoon(label6c, "img/daseul/text8.png");
